...
config :studysync, StudysyncWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/studysync_web/router\.ex$"E,
      ~r"lib/studysync_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :studysync, dev_routes: true, token_signing_secret: "ygQhBYGNpPqt+/Trn85wRKcqX8cvDgKo"
