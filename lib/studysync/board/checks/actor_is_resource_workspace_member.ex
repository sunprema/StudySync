defmodule Studysync.Board.Checks.ActorIsResourceWorkspaceMember do
  @moduledoc """
  Authorizes any active workspace member to perform board actions.
  Reuses the same membership-check logic as the annotations domain.
  """
